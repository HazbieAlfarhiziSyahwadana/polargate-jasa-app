                ...
                <nav class="flex-1 overflow-y-auto py-6 px-3">
                    ...
                    <div x-data="{ open: {{ request()->routeIs('admin.laporan.*') ? 'true' : 'false' }} }" class="mb-1">
                        ...
                        <div x-show="open" x-transition class="ml-4 mt-1 space-y-1">
                            <a href="{{ route('admin.laporan.keuangan') }}" class="block px-4 py-2 text-sm text-blue-100 hover:text-white hover:bg-white hover:bg-opacity-10 rounded-lg">Keuangan</a>
                            <a href="{{ route('admin.laporan.pemesanan') }}" class="block px-4 py-2 text-sm text-blue-100 hover:text-white hover:bg-white hover:bg-opacity-10 rounded-lg">Pemesanan</a>
                            <a href="{{ route('admin.laporan.client') }}" class="block px-4 py-2 text-sm text-blue-100 hover:text-white hover:bg-white hover:bg-opacity-10 rounded-lg">Client</a>
                        </div>
                    </div>
                </nav>
            ...
            <header class="bg-white shadow-md border-b border-gray-200">
                <div class="flex items-center justify-between px-6 py-4">
                    ...
                    <div class="flex-1 max-w-xl mx-4 hidden md:block">
                        <div class="relative">
                            <input type="search" placeholder="Cari..." class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl py-2 z-50 border border-gray-100">
                            <a href="{{ route('admin.profil') }}" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition">
