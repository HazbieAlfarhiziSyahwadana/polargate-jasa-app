...
<div class="animate-fade">
    <div class="mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Update informasi paket <span class="font-semibold text-primary-600">{{ $paket->nama_paket }}</span></p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-4xl animate-slide">
        <div class="card">
            ...
            <form action="{{ route('admin.paket.update', $paket) }}" method="POST" x-data="paketForm()" class="space-y-6">
                @csrf
                @method('PUT')

                <!-- Layanan -->
                <div class="relative" x-data="{ open: false, selected: {{ old('layanan_id', $paket->layanan_id) ?? 'null' }} }">
                ...
                <div x-init="fiturList = {{ json_encode(old('fitur', $paket->fitur)) }}">
