...
<div class="animate-fade-in">
    ...
    <div class="mb-8 animate-slide-down">
        <div class="flex items-center gap-3 mb-3">
            ...
            <div>
                <h1 class="text-3xl md:text-4xl font-bold text-gray-800">Edit Add-on</h1>
                <p class="text-gray-600 mt-1">Update informasi add-on <span class="font-semibold text-primary-600">{{ $addon->nama_addon }}</span></p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-4xl animate-slide-up">
        <div class="card">
            <!-- Info Banner -->
            <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-500 rounded-lg animate-slide-in">
            ...
            <form action="{{ route('admin.addon.update', $addon) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')

                <!-- Layanan -->
                <div class="form-group-animated" x-data="{ open: false, selected: {{ old('layanan_id', $addon->layanan_id) ?? 'null' }} }">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group-animated">
                        ...
                        <input type="text" name="nama_addon" id="nama_addon" 
                               value="{{ old('nama_addon', $addon->nama_addon) }}" 
                               class="input-field @error('nama_addon') border-red-500 @enderror" required>
                        @error('nama_addon')
                        <p class="error-message">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group-animated">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="harga" id="harga" 
                                   ...
                                   class="input-field @error('harga') border-red-500 @enderror pl-12" required>
                        </div>
                        @error('harga')
                        <p class="error-message">{{ $message }}</p>
                        @enderror
                ...
                <div class="form-group-animated">
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="4" 
                              class="input-field @error('deskripsi') border-red-500 @enderror resize-none" required>{{ old('deskripsi', $addon->deskripsi) }}</textarea>
                    @error('deskripsi')
                    <p class="error-message">{{ $message }}</p>
                    @enderror
                </div>
